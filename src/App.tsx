...
const yourBio = `I'm a multidisciplinary Research & Data Analyst with a passion for translating complex systems into actionable strategies. I bring a unique perspective to my work. I specialize in regulatory insights and turning data into decision-ready insights across healthcare, venture capital, and higher education. I believe in clear communication, thoughtful program design, and building infrastructure that empowers both users and organizations. Recently, I graduated from Brown University in December 2024, where I was accepted as one of only ten Resumed Undergraduate Education students in 2021. When I'm not improving the efficacy of workflows or supporting innovative and engaging student activities, you'll find me crocheting, doing home workouts, or hanging out with my cat, Mama.`;
